	...
	<div class="side">
		...
		<ul class="menu">
			...
			@auth
				...
				<li class="selected"><a href="{{route('user.index')}}"><i class="zmdi zmdi-accounts-alt"></i> Users </a></li>
			...
			<div class="list">
                <div class="content">
					...
					@foreach ($userList as $user)
                        <li>
							<span style="font-weight: bold"><a href="{{route('user.show', $user->id)}}">{{$user->name}}</a></span>
