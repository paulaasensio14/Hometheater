...
<div class="wrapper"> 
	<div class="side">
		...
		<ul class="menu">
			...
			<li class="selected"><a href="{{route('person.index')}}"><i class="zmdi zmdi-accounts-list"></i> People</a></li>
			<br><br>
			@guest
			...
			<div class="list">
                <div class="content">
                    ...
                    @foreach ($peopleList as $person)
                        <li>
                            <a href="{{route('person.show', $person->id)}}"><img src="{{url('photos/'.$person->photo)}}" alt="{{$person->name}}"></a>
